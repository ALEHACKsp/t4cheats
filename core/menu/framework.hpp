...
namespace menu_framework {
	...
	void sliderf(std::int32_t* x, std::int32_t* y, std::int32_t position, unsigned long font, const std::string string, float& value, float min_value, float max_value);
	void slider(std::int32_t* x, std::int32_t* y, std::int32_t position, unsigned long font, const std::string string, int& value, int min_value, int max_value);
