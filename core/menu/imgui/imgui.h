...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API
    IMGUI_API void          StyleColorsDarker(ImGuiStyle* dst = NULL);          // new, recommended style (default)
    ...
    IMGUI_API bool          Combo(const char* label, int* currIndex, std::vector<std::string>& values);//pines
