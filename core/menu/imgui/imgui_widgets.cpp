...
bool ImGui::ColorEdit4(const char* label, color* col, ImGuiColorEditFlags flags) //thx to hoppa for fixing this, luv u :))
{
    float col4[4];
    col4[0] = col->r / 255.f; col4[1] = col->g / 255.f; col4[2] = col->b / 255.f; col4[3] = col->a / 255.f;
    if(ColorEdit4(label, col4, flags));
    {
        col->r = col4[0] * 255.f; col->g = col4[1] * 255.f; col->b = col4[2] * 255.f; col->a = col4[3] * 255.f;
        return true;
    }
}
